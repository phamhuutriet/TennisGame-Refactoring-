...
class TennisGame1:
    ...
    def gameState_factory(self):
        if self.is_advantage():
          return AdvantageState(self.p1points, self.p2points, self)
        elif self.is_won():
          return WonState(self.p1points, self.p2points, self)
        elif self.is_equal_score():
          return EqualState(self.p1points, self.p2points, self)
        else:
          return NormalState(self.p1points, self.p2points, self)
